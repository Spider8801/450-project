...
#include <netdb.h>
#include <signal.h>
#define MYPORT "42389" // the port users will be connecting to
...
int main(void)
{
	...
	while (1)
	{
		...
		printf("The ServerCS received a request from the Main Server about %s of %s", array[1], array[0]);
